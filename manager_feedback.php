		...
		<tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td style='text-align:center'><a href="?page=manager_feedback&&function=del&&id=<?php echo $row["fb_id"];?>" onclick="deleteConfirm()"><img src='images/delete.png' border='0'></a></td>
            <?php
                $No++;
                }
            ?>
